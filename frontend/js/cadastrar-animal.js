...
document.getElementById('inputFoto').addEventListener('change', function () {
    ...
    reader.onload = e => {
        ...
        preview.src = fotoDataUrl; preview.style.display = 'block';
...
document.getElementById('btnCadastrar').addEventListener('click', () => {
    ...
    if (!ok) return;
    ANIMAIS.push({ id:Date.now(), nome, especie, raca:raca||null, data_nascimento:dataNasc||null,
        status:'disponivel', ong_id:sess.id, ong_nome:sess.nome,
        enfermidade:enfermidadeVal==='sim'?descEnf:null, descricao, foto_url:fotoDataUrl||null });
